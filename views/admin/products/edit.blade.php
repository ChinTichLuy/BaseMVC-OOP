                    ...
                    <div class="container">
                        <div class="container">
                            <form action="/admin/products/update/{{ $product['p_id'] }}" method="POST"
                                ...
                                <div class="mb-3 row">
                                    <label for="category_id" class="col-4 col-form-label">Catgory</label>
                                    <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-8">
                                        <textarea class="form-control" name="overview" id="overview">{{ $product['p_overview'] ?? null }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="content" class="col-4 col-form-label">Content</label>
                                    <div class="col-8">
                                        <textarea class="form-control" name="content" id="content">{!! $product['p_content'] !!}</textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="img_thumbnail" class="col-4 col-form-label">Image Thumbnail</label>
                                    <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-8">
                                        <input type="number" class="form-control" name="price_sale" id="price_sale"
                                            value="{{ $product['p_price_sale'] ?? 0 }}" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="is_active" class="col-4 col-form-label">Is Active</label>
                                    <div class="col-8">
                                        <input type="checkbox" class="form-checkbox" @checked($product['p_is_active']) name="is_active" id="is_active"
                                            value="1" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-8">
                                        <input type="checkbox" class="form-checkbox"  @checked($product['p_is_sale']) name="is_sale" id="is_sale"
                                            value="1" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-8">
                                        <input type="checkbox" class="form-checkbox" @checked($product['p_is_show_home'])  name="is_show_home" id="is_show_home"
                                            value="1" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
