                        ...
                        <div class="container">
                            <form action="/admin/products/store" method="POST" enctype="multipart/form-data">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-8">
                                        <input type="text" class="form-control" name="name" id="name"
                                            value="{{ $_SESSION['data']['name'] ?? null }}" placeholder="Name" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-8">
                                        <textarea class="form-control" name="overview" id="overview">{{ $_SESSION['data']['overview'] ?? null }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="content" class="col-4 col-form-label">Content</label>
                                    <div class="col-8">
                                        <textarea class="form-control" name="content" id="content">{!! $_SESSION['data']['content'] ?? null !!}</textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
