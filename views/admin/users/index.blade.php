...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ $title }}w</li>
        </ol>
    </nav>
                                ...
                                @foreach ($data as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/admin/users/delete/{{ $user['id'] }}" onclick="return confirm('Are you SURE about that?')" class="btn btn-sm btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
